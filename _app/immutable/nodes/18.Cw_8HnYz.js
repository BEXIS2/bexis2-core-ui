import{s as Q,e as u,t as se,a as C,c as f,b as D,d as re,f as v,g as T,A as y,m as c,i as B,h as i,N as We,n as N,z as Ne,r as lt,af as vn,j as ge,T as Oe,H as xn,l as _n,u as Cn,o as Tn,p as wn,v as je,O as Dn,U as yn,k as hn}from"../chunks/scheduler.B-h4_l2j.js";import{S as X,i as ee,c as M,a as A,m as V,t as E,b as S,d as H,g as it,e as ot,k as In}from"../chunks/index.Bhsty9LT.js";/* empty css                             */import{p as at}from"../chunks/floating-ui.dom.BYxYz9V7.js";import"../chunks/ProgressBar.svelte_svelte_type_style_lang.BqWvL3q3.js";import{C as Pe}from"../chunks/CodeBlock.Dw3wa0M4.js";import{M as En}from"../chunks/Modal.BgKchWab.js";import{g as Ln}from"../chunks/stores.ZfkYPW1a.js";import{e as pe}from"../chunks/each.Dw8uFo0Y.js";import{F as Sn,e as Un,g as kn,d as Mn,c as An}from"../chunks/index.BJr47QUZ.js";import{w as He}from"../chunks/index.rSSxKMQm.js";import{a as Vn,b as Hn,T as ve,c as Rn,d as Gn,C as ze}from"../chunks/CodeContainer.DJiINXqT.js";import{a as Fn,t as Bn}from"../chunks/stores.Dy3YFOjr.js";function On(o,e){var b;let n="h2, h3, h4, h5, h6",t="body",s,l=[];function r(){e!=null&&e.queryElements&&(n=e.queryElements),e!=null&&e.scrollTarget&&(t=e.scrollTarget),s=o.querySelectorAll(n),l=[],d()}function d(){s==null||s.forEach(m=>{var x,g,h,p;if(!m.hasAttribute("data-toc-ignore")){if((e==null?void 0:e.mode)==="generate"&&!m.id){const $=(g=(x=m.firstChild)==null?void 0:x.textContent)==null?void 0:g.trim().replaceAll(/[^a-zA-Z0-9 ]/g,"").replaceAll(" ","-").toLowerCase(),w=e.prefix?`${e.prefix}-`:"",_=e.suffix?`-${e.suffix}`:"";m.id=w+$+_}l.push({element:m.nodeName.toLowerCase(),id:m.id,text:((p=(h=m.firstChild)==null?void 0:h.textContent)==null?void 0:p.trim())||""})}}),Fn.set(l)}function a(m){if(!(s!=null&&s.length))return;const x=m.target;if(!(x instanceof HTMLElement))throw new Error("scrollTarget is not an HTMLElement");const g=x.getBoundingClientRect().top||0,h=40;for(const p of s)if(p.getBoundingClientRect().top-g+h>=0)return Bn.set(p.id)}return r(),t&&((b=document.querySelector(t))==null||b.addEventListener("scroll",a)),{update(m){e=m,r()},destroy(){var m;t&&((m=document.querySelector(t))==null||m.removeEventListener("scroll",a))}}}const jn=`
<script lang="ts">
