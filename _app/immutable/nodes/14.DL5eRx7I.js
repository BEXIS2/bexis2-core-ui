...
`;function Ht(r){let t,n,e,s="default",a,p,m,o,d,h="change color",i,l,$,w,T,B="change position",A,P,L,y,U,W="add text",q,j,z;return p=new st({}),l=new st({props:{textCss:"text-primary-500"}}),P=new st({props:{textCss:"text-secondary-500",position:mt.center}}),j=new st({props:{textCss:"text-surface-500",label:"validation is running, please waiting until dead"}}),{c(){t=v("div"),n=v("div"),e=v("h4"),e.textContent=s,a=C(),M(p.$$.fragment),m=C(),o=v("div"),d=v("h4"),d.textContent=h,i=C(),M(l.$$.fragment),$=C(),w=v("div"),T=v("h4"),T.textContent=B,A=C(),M(P.$$.fragment),L=C(),y=v("div"),U=v("h4"),U.textContent=W,q=C(),M(j.$$.fragment),this.h()},l(f){t=g(f,"DIV",{class:!0});var E=O(t);n=g(E,"DIV",{});var F=O(n);e=g(F,"H4",{class:!0,"data-svelte-h":!0}),k(e)!=="svelte-1minar4"&&(e.textContent=s),a=b(F),N(p.$$.fragment,F),F.forEach(c),m=b(E),o=g(E,"DIV",{});var tt=O(o);d=g(tt,"H4",{class:!0,"data-svelte-h":!0}),k(d)!=="svelte-1b3f6nw"&&(d.textContent=h),i=b(tt),N(l.$$.fragment,tt),tt.forEach(c),$=b(E),w=g(E,"DIV",{});var et=O(w);T=g(et,"H4",{class:!0,"data-svelte-h":!0}),k(T)!=="svelte-as01sa"&&(T.textContent=B),A=b(et),N(P.$$.fragment,et),et.forEach(c),L=b(E),y=g(E,"DIV",{});var nt=O(y);U=g(nt,"H4",{class:!0,"data-svelte-h":!0}),k(U)!=="svelte-p9005r"&&(U.textContent=W),q=b(nt),N(j.$$.fragment,nt),nt.forEach(c),E.forEach(c),this.h()},h(){u(e,"class","h4"),u(d,"class","h4"),u(T,"class","h4"),u(U,"class","h4"),u(t,"class","grid grid-cols-1 space-y-10 divide-y-2")},m(f,E){x(f,t,E),_(t,n),_(n,e),_(n,a),H(p,n,null),_(t,m),_(t,o),_(o,d),_(o,i),H(l,o,null),_(t,$),_(t,w),_(w,T),_(w,A),H(P,w,null),_(t,L),_(t,y),_(y,U),_(y,q),H(j,y,null),z=!0},p:V,i(f){z||(I(p.$$.fragment,f),I(l.$$.fragment,f),I(P.$$.fragment,f),I(j.$$.fragment,f),z=!0)},o(f){D(p.$$.fragment,f),D(l.$$.fragment,f),D(P.$$.fragment,f),D(j.$$.fragment,f),z=!1},d(f){f&&c(t),S(p),S(l),S(P),S(j)}}}class Nt extends G{constructor(t){super(),K(this,t,null,Ht,J,{})}}const Mt=`<script>
...
`,ct={helpItems:[{id:"name",name:"Name",description:"<p>Lorem ipsum dolor sit amet,</p>",link:"https://bexis2.github.io/bexis2-core-ui/"},{id:"description",name:"Description",description:"Lorem ipsum dolor sit ame."}]};function At(r){let t,n="Basic Usage",e,s,a,p="Name",m,o,d="Description",h,i,l="Use with Inputs",$,w,T=`Some inputs have the mouseover and mouseout functions for the help build in you just have to
	enable them.`,B,A,P,L,y,U,W,q,j,z;return P=new dt({props:{id:"name",label:"Name of something important",help:at}}),y=new ht({props:{id:"description",label:"Description to understand what happen in the world",help:at}}),W=new ft({props:{active:at}}),{c(){t=v("h3"),t.textContent=n,e=C(),s=v("div"),a=v("p"),a.textContent=p,m=C(),o=v("p"),o.textContent=d,h=C(),i=v("h3"),i.textContent=l,$=C(),w=v("p"),w.textContent=T,B=C(),A=v("div"),M(P.$$.fragment),L=C(),M(y.$$.fragment),U=C(),M(W.$$.fragment),this.h()},l(f){t=g(f,"H3",{class:!0,"data-svelte-h":!0}),k(t)!=="svelte-1qvz4ut"&&(t.textContent=n),e=b(f),s=g(f,"DIV",{class:!0});var E=O(s);a=g(E,"P",{class:!0,id:!0,"data-svelte-h":!0}),k(a)!=="svelte-1p17h9q"&&(a.textContent=p),m=b(E),o=g(E,"P",{class:!0,id:!0,"data-svelte-h":!0}),k(o)!=="svelte-602myc"&&(o.textContent=d),E.forEach(c),h=b(f),i=g(f,"H3",{class:!0,"data-svelte-h":!0}),k(i)!=="svelte-1gw5i7i"&&(i.textContent=l),$=b(f),w=g(f,"P",{"data-svelte-h":!0}),k(w)!=="svelte-1xm8pvb"&&(w.textContent=T),B=b(f),A=g(f,"DIV",{class:!0});var F=O(A);N(P.$$.fragment,F),L=b(F),N(y.$$.fragment,F),F.forEach(c),U=b(f),N(W.$$.fragment,f),this.h()},h(){u(t,"class","h3"),u(a,"class","p-5"),u(a,"id","name"),u(o,"class","p-5"),u(o,"id","description"),u(s,"class","p-5"),u(i,"class","h3"),u(A,"class","p-5")},m(f,E){x(f,t,E),x(f,e,E),x(f,s,E),_(s,a),_(s,m),_(s,o),x(f,h,E),x(f,i,E),x(f,$,E),x(f,w,E),x(f,B,E),x(f,A,E),H(P,A,null),_(A,L),H(y,A,null),x(f,U,E),H(W,f,E),q=!0,j||(z=[R(a,"mouseover",r[0]),R(a,"focus",r[1]),R(o,"mouseover",r[2]),R(o,"focus",r[3])],j=!0)},p:V,i(f){q||(I(P.$$.fragment,f),I(y.$$.fragment,f),I(W.$$.fragment,f),q=!0)},o(f){D(P.$$.fragment,f),D(y.$$.fragment,f),D(W.$$.fragment,f),q=!1},d(f){f&&(c(t),c(e),c(s),c(h),c(i),c($),c(w),c(B),c(A),c(U)),S(P),S(y),S(W,f),j=!1,lt(z)}}}let at=!0;function Pt(r){let t=ct.helpItems;return Y.setHelpItemList(t),[()=>{Y.show("name")},()=>{Y.show("name")},()=>{Y.show("description")},()=>{Y.show("description")}]}class Lt extends G{constructor(t){super(),K(this,t,Pt,At,J,{})}}const Vt=`<script lang="ts">
