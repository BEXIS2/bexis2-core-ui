...
export const groupsStore = writable<Group[]>(userGroups);`,Zs=`
<script lang="ts">
	import { Table } from '@bexis2/bexis2-core-ui';
	import type { TableConfig } from '@bexis2/bexis2-core-ui';
...
`;function Cn(a){let e,s,t,n="TableConfig <T>",i,l,f,c="Show type details",h,m,C="Underlined attributes are <strong>required</strong>.",v,b,p,_,T,w='<div class="flex gap-2 underline"><div class="italic">id:</div> <div class="font-bold">string</div></div> <p class="text-xl pl-10">Unique identifier for the table to generate unique IDs for the filters.</p>',I,L,k,B,N="data:",P,ne,q="Writable <T[]>",W,ee,Q,Z='A writable store of the type <code class="!text-xl bg-tertiary-300 dark:bg-tertiary-700/50 rounded-md p-0.5 text-primary-500">T[]</code>. Any changes in the store will be reflected in the table.',X,te,U='<div class="flex gap-2"><div class="italic">resizable:</div> <div class="font-bold"><i>&quot;rows&quot;</i>, <i>&quot;columns&quot;</i> or <i>&quot;both&quot;</i></div></div> <p class="text-xl pl-10">Whether rows, columns or both should be resizable. Not resizable by default.</p>',O,z,Y='<div class="flex gap-2"><div class="italic">showColumnsMenu:</div> <div class="font-bold">boolean</div></div> <p class="text-xl pl-10">Whether the show/hide columns menu should be visible. <code class="!text-xl bg-red-100 dark:bg-red-400/30 rounded-md p-0.5 text-red-500">false</code> by default.</p>',ue,se,re=`<div class="flex gap-2"><div class="italic">toggle:</div> <div class="font-bold">boolean</div></div> <p class="text-xl pl-10">Whether the <code class="!text-xl bg-tertiary-300 dark:bg-tertiary-700/50 rounded-md p-0.5 text-primary-500">fitToScreen</code>
			...
			100.`,Et,Le,Se,je,Ot="defaultPageSize:",Lt,Ze,qt="number",St,Mt,Oe,zt=`Default page size to be used for the table upon rendering. By default, default page size is
			...
			column if no <code class="!text-xl bg-tertiary-300 dark:bg-tertiary-700/50 rounded-md p-0.5 text-primary-500">optionsComponent</code> was provided.`,at,Ht,Jt;return p=new it({props:{language:"ts",code:tn}}),{c(){e=u("div"),s=u("div"),t=u("h3"),i=de(n),l=x(),f=u("button"),f.textContent=c,h=x(),m=u("div"),m.innerHTML=C,v=x(),b=u("div"),R(p.$$.fragment),_=x(),T=u("div"),T.innerHTML=w,I=x(),L=u("div"),k=u("div"),B=u("div"),B.textContent=N,P=x(),ne=u("div"),W=de(q),ee=x(),Q=u("p"),Q.innerHTML=Z,X=x(),te=u("div"),te.innerHTML=U,O=x(),z=u("div"),z.innerHTML=Y,ue=x(),se=u("div"),se.innerHTML=re,S=x(),j=u("div"),j.innerHTML=fe,G=x(),le=u("div"),le.innerHTML=we,Ae=x(),$e=u("div"),$e.innerHTML=xe,Pe=x(),he=u("div"),he.innerHTML=We,Je=x(),me=u("div"),pe=u("div"),ve=u("div"),ve.textContent=st,De=x(),ge=u("div"),ye=de(He),Ye=x(),Re=u("p"),Re.innerHTML=Rt,Tt=x(),Ge=u("div"),Ge.innerHTML=Gt,wt=x(),Ie=u("div"),Ee=u("div"),Fe=u("div"),Fe.textContent=Ft,Dt=x(),Ke=u("div"),yt=de(Bt),It=x(),Be=u("p"),Be.textContent=jt,Et=x(),Le=u("div"),Se=u("div"),je=u("div"),je.textContent=Ot,Lt=x(),Ze=u("div"),St=de(qt),Mt=x(),Oe=u("p"),Oe.textContent=zt,Ut=x(),Me=u("div"),Ue=u("div"),qe=u("div"),qe.textContent=Nt,kt=x(),Qe=u("div"),Vt=de(Pt),At=x(),ze=u("p"),ze.innerHTML=Wt,this.h()},l(_e){e=d(_e,"DIV",{class:!0});var K=D(e);s=d(K,"DIV",{class:!0,id:!0});var ke=D(s);t=d(ke,"H3",{class:!0});var Yt=D(t);i=ce(Yt,n),Yt.forEach(g),l=$(ke),f=d(ke,"BUTTON",{class:!0,"data-svelte-h":!0}),y(f)!=="svelte-8jx6w5"&&(f.textContent=c),h=$(ke),m=d(ke,"DIV",{class:!0,"data-svelte-h":!0}),y(m)!=="svelte-pow2wl"&&(m.innerHTML=C),v=$(ke),b=d(ke,"DIV",{"data-popup":!0});var Kt=D(b);H(p.$$.fragment,Kt),Kt.forEach(g),ke.forEach(g),_=$(K),T=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(T)!=="svelte-1gw1p6o"&&(T.innerHTML=w),I=$(K),L=d(K,"DIV",{class:!0});var ot=D(L);k=d(ot,"DIV",{class:!0});var ct=D(k);B=d(ct,"DIV",{class:!0,"data-svelte-h":!0}),y(B)!=="svelte-1nos06z"&&(B.textContent=N),P=$(ct),ne=d(ct,"DIV",{class:!0});var Zt=D(ne);W=ce(Zt,q),Zt.forEach(g),ct.forEach(g),ee=$(ot),Q=d(ot,"P",{class:!0,"data-svelte-h":!0}),y(Q)!=="svelte-1c6igtm"&&(Q.innerHTML=Z),ot.forEach(g),X=$(K),te=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(te)!=="svelte-okxdta"&&(te.innerHTML=U),O=$(K),z=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(z)!=="svelte-20vmk1"&&(z.innerHTML=Y),ue=$(K),se=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(se)!=="svelte-10v9e21"&&(se.innerHTML=re),S=$(K),j=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(j)!=="svelte-1vcf6xb"&&(j.innerHTML=fe),G=$(K),le=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(le)!=="svelte-wrmk9w"&&(le.innerHTML=we),Ae=$(K),$e=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y($e)!=="svelte-mswvp"&&($e.innerHTML=xe),Pe=$(K),he=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(he)!=="svelte-1d6cyak"&&(he.innerHTML=We),Je=$(K),me=d(K,"DIV",{class:!0});var dt=D(me);pe=d(dt,"DIV",{class:!0});var ut=D(pe);ve=d(ut,"DIV",{class:!0,"data-svelte-h":!0}),y(ve)!=="svelte-1rr4g9w"&&(ve.textContent=st),De=$(ut),ge=d(ut,"DIV",{class:!0});var Qt=D(ge);ye=ce(Qt,He),Qt.forEach(g),ut.forEach(g),Ye=$(dt),Re=d(dt,"P",{class:!0,"data-svelte-h":!0}),y(Re)!=="svelte-1rn1eyk"&&(Re.innerHTML=Rt),dt.forEach(g),Tt=$(K),Ge=d(K,"DIV",{class:!0,"data-svelte-h":!0}),y(Ge)!=="svelte-1lqyjpj"&&(Ge.innerHTML=Gt),wt=$(K),Ie=d(K,"DIV",{class:!0});var ft=D(Ie);Ee=d(ft,"DIV",{class:!0});var pt=D(Ee);Fe=d(pt,"DIV",{class:!0,"data-svelte-h":!0}),y(Fe)!=="svelte-1vi8og4"&&(Fe.textContent=Ft),Dt=$(pt),Ke=d(pt,"DIV",{class:!0});var Xt=D(Ke);yt=ce(Xt,Bt),Xt.forEach(g),pt.forEach(g),It=$(ft),Be=d(ft,"P",{class:!0,"data-svelte-h":!0}),y(Be)!=="svelte-6kwyqj"&&(Be.textContent=jt),ft.forEach(g),Et=$(K),Le=d(K,"DIV",{class:!0});var mt=D(Le);Se=d(mt,"DIV",{class:!0});var gt=D(Se);je=d(gt,"DIV",{class:!0,"data-svelte-h":!0}),y(je)!=="svelte-6pyrz4"&&(je.textContent=Ot),Lt=$(gt),Ze=d(gt,"DIV",{class:!0});var es=D(Ze);St=ce(es,qt),es.forEach(g),gt.forEach(g),Mt=$(mt),Oe=d(mt,"P",{class:!0,"data-svelte-h":!0}),y(Oe)!=="svelte-qswi2h"&&(Oe.textContent=zt),mt.forEach(g),Ut=$(K),Me=d(K,"DIV",{class:!0});var vt=D(Me);Ue=d(vt,"DIV",{class:!0});var ht=D(Ue);qe=d(ht,"DIV",{class:!0,"data-svelte-h":!0}),y(qe)!=="svelte-k4lnpy"&&(qe.textContent=Nt),kt=$(ht),Qe=d(ht,"DIV",{class:!0});var ts=D(Qe);Vt=ce(ts,Pt),ts.forEach(g),ht.forEach(g),At=$(vt),ze=d(vt,"P",{class:!0,"data-svelte-h":!0}),y(ze)!=="svelte-1wwqj0k"&&(ze.innerHTML=Wt),vt.forEach(g),K.forEach(g),this.h()},h(){o(t,"class","font-semibold relative w-max h3"),o(f,"class","btn variant-ghost-primary w-min"),o(m,"class","italic div"),o(b,"data-popup","popupClickTableConfig"),o(s,"class","grid gap-2"),o(s,"id","tableConfig"),o(T,"class","items-center"),o(B,"class","italic"),o(ne,"class","font-bold"),o(k,"class","flex gap-2 underline"),o(Q,"class","text-xl pl-10"),o(L,"class","items-center"),o(te,"class","items-center"),o(z,"class","items-center"),o(se,"class","items-center"),o(j,"class","items-center"),o(le,"class","items-center"),o($e,"class","items-center"),o(he,"class","items-center"),o(ve,"class","italic"),o(ge,"class","font-bold"),o(pe,"class","flex gap-2"),o(Re,"class","text-xl pl-10"),o(me,"class","items-center"),o(Ge,"class","items-center"),o(Fe,"class","italic"),o(Ke,"class","font-bold"),o(Ee,"class","flex gap-2"),o(Be,"class","text-xl pl-10"),o(Ie,"class","items-center"),o(je,"class","italic"),o(Ze,"class","font-bold"),o(Se,"class","flex gap-2"),o(Oe,"class","text-xl pl-10"),o(Le,"class","items-center"),o(qe,"class","italic"),o(Qe,"class","font-bold"),o(Ue,"class","flex gap-2"),o(ze,"class","text-xl pl-10"),o(Me,"class","items-center"),o(e,"class","grid gap-5")},m(_e,K){F(_e,e,K),r(e,s),r(s,t),r(t,i),r(s,l),r(s,f),r(s,h),r(s,m),r(s,v),r(s,b),A(p,b,null),r(e,_),r(e,T),r(e,I),r(e,L),r(L,k),r(k,B),r(k,P),r(k,ne),r(ne,W),r(L,ee),r(L,Q),r(e,X),r(e,te),r(e,O),r(e,z),r(e,ue),r(e,se),r(e,S),r(e,j),r(e,G),r(e,le),r(e,Ae),r(e,$e),r(e,Pe),r(e,he),r(e,Je),r(e,me),r(me,pe),r(pe,ve),r(pe,De),r(pe,ge),r(ge,ye),r(me,Ye),r(me,Re),r(e,Tt),r(e,Ge),r(e,wt),r(e,Ie),r(Ie,Ee),r(Ee,Fe),r(Ee,Dt),r(Ee,Ke),r(Ke,yt),r(Ie,It),r(Ie,Be),r(e,Et),r(e,Le),r(Le,Se),r(Se,je),r(Se,Lt),r(Se,Ze),r(Ze,St),r(Le,Mt),r(Le,Oe),r(e,Ut),r(e,Me),r(Me,Ue),r(Ue,qe),r(Ue,kt),r(Ue,Qe),r(Qe,Vt),r(Me,At),r(Me,ze),at=!0,Ht||(Jt=nt($t.call(null,f,a[0])),Ht=!0)},p:J,i(_e){at||(E(p.$$.fragment,_e),at=!0)},o(_e){M(p.$$.fragment,_e),at=!1},d(_e){_e&&g(e),V(p),Ht=!1,Jt()}}}function Tn(a){return[{event:"click",target:"popupClickTableConfig",placement:"right"}]}class wn extends ae{constructor(e){super(),oe(this,e,Tn,Cn,ie,{})}}function Dn(a){let e,s,t,n="Columns",i,l,f="Show type details",c,h,m,C,v,b=`<div class="flex gap-2"><div class="italic">[key: <strong>string</strong>]:</div> <div class="font-bold">Column</div></div> <p class="text-xl pl-10">Each key of this object is an accessor in the data object. If a certain key is not present,
