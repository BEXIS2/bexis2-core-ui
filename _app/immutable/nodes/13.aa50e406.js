...
`,dt={helpItems:[{id:"name",name:"Name",description:"<p>Lorem ipsum dolor sit amet,</p>",link:"https://bexis2.github.io/bexis2-core-ui/"},{id:"description",name:"Description",description:"Lorem ipsum dolor sit ame."}]};function jt(f){let t,n,e,s,o,u,m,p,b,d,i,l,$,T,I,w,y,U,V,D,O,j,F,W,q;return U=new bt({props:{id:"name",label:"Name of something important",help:ct}}),D=new wt({props:{id:"description",label:"Description to understand what happen in the world",help:ct}}),j=new $t({props:{active:ct}}),{c(){t=g("h3"),n=k("Basic Usage"),e=x(),s=g("div"),o=g("p"),u=k("Name"),m=x(),p=g("p"),b=k("Description"),d=x(),i=g("h3"),l=k("Use with Inputs"),$=x(),T=g("p"),I=k(`Some inputs have the mouseover and mouseout functions for the help build in you just have to
