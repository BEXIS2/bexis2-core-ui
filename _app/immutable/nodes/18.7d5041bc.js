import{S as Ee,i as De,s as we,k as n,q as p,a as g,y as H,l as i,m as c,r as h,h as o,c as b,z,n as a,b as Z,F as t,A as W,aa as zs,Z as re,g as G,d as L,B as q,v as Ir,f as Vr,a0 as js,N as xr,a7 as Kl,u as ds,a9 as Cr,P as to,E as so,G as ro,H as lo,I as oo,e as Ns,w as ao,a6 as no,a8 as io,_ as Ql}from"../chunks/index.9a980381.js";/* empty css                             */import{p as Sr}from"../chunks/floating-ui.dom.5818a20f.js";import"../chunks/ProgressBar.svelte_svelte_type_style_lang.61f4aed8.js";import{C as Ws}from"../chunks/CodeBlock.a256fc37.js";import{M as co}from"../chunks/Modal.2494a66e.js";import{g as uo}from"../chunks/stores.2391b548.js";import{F as fo,e as po,g as ho,d as mo,c as vo}from"../chunks/index.7f473b84.js";import{w as Hs}from"../chunks/index.5c326a8b.js";import{a as go,b as bo,T as _s,c as _o,d as $o,C as qs}from"../chunks/CodeContainer.76ea85c0.js";import{a as Eo,t as Do}from"../chunks/stores.cc300363.js";function wo(f,e){var D;let r="h2, h3, h4, h5, h6",s="body",l,u=[];function d(){e!=null&&e.queryElements&&(r=e.queryElements),e!=null&&e.scrollTarget&&(s=e.scrollTarget),l=f.querySelectorAll(r),u=[],v()}function v(){l==null||l.forEach(_=>{var C,y,T,I;if(!_.hasAttribute("data-toc-ignore")){if((e==null?void 0:e.mode)==="generate"&&!_.id){const U=(y=(C=_.firstChild)==null?void 0:C.textContent)==null?void 0:y.trim().replaceAll(/[^a-zA-Z0-9 ]/g,"").replaceAll(" ","-").toLowerCase(),V=e.prefix?`${e.prefix}-`:"",$=e.suffix?`-${e.suffix}`:"";_.id=V+U+$}u.push({element:_.nodeName.toLowerCase(),id:_.id,text:((I=(T=_.firstChild)==null?void 0:T.textContent)==null?void 0:I.trim())||""})}}),Eo.set(u)}function m(_){if(!(l!=null&&l.length))return;const C=_.target;if(!(C instanceof HTMLElement))throw new Error("scrollTarget is not an HTMLElement");const y=C.getBoundingClientRect().top||0,T=40;for(const I of l)if(I.getBoundingClientRect().top-y+T>=0)return Do.set(I.id)}return d(),s&&((D=document.querySelector(s))==null||D.addEventListener("scroll",m)),{update(_){e=_,d()},destroy(){var _;s&&((_=document.querySelector(s))==null||_.removeEventListener("scroll",m))}}}const yo=`
<script lang="ts">
