...
<div class="p-5 flex flex-col gap-5">
	...
	<div class="flex gap-2">
		...
		<button class="btn variant-ghost-primary" on:click={() => getMetadataAsJson()}
			>Get Metadata as JSON</button
		>
		<button class="btn variant-ghost-primary" on:click={() => getMetadataAsXml()}
			>Get Metadata as XML</button
		>
	</div>
